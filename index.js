...
client.on('raw', (raw) => {
  if (raw.t && !['READY', 'GUILD_CREATE', 'MESSAGE_CREATE', 'VOICE_STATE_UPDATE', 'VOICE_SERVER_UPDATE'].includes(raw.t))
    log(colors.red(raw.t));
});

// This token I use for important things such as streaming to vc
// Please don't reset because I don't like dms from system
